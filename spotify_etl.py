...
def fetch_spotify_artist_data():
    client_id = 'b19960c6a802437b9fb2e6dbb1d5***'
    client_secret = '3819***b6c9d46e****3612239***'
...
if __name__ == "__main__":
    artist_data_df = fetch_spotify_artist_data()
    artist_data_df.to_csv('s3://21121a2933/spotify_artist_data.csv', index=False)
